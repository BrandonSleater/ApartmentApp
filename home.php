		...
		<div class="container apt-form">
			...
			<form class="form-horizontal col-md-5" style="" role="form" name="apt-search" id="apt-search" action="php/post.php" method="POST">
				...
				<div class="form-group" style="margin-bottom: -50px">
					...
					<div class="radio-inline">
						<label><input type="radio" style="margin-left: 0" name="p_range" id="p-lt" value="lt" checked> <= 700 </label>

						<label><input type="radio" style="margin-left: 10px" name="p_range" id="p-gt" value="gt"> > 700 </label>
					</div>
				</div>
				...
				<div class="form-group frm-inp-tight">
				  	...
				  	<div class="col-md-4">
					  	<div class="checkbox">
					    	<label for="has_washdry"><input type="checkbox" name="has_washdry" id="has_washdry" value="1"> Washer/Dryer </label>
						</div>
					  	
					  	<div class="checkbox">
					    	<label for="has_patio"><input type="checkbox" name="has_patio" id="has_patio" value="1"> Patio/Balcony </label>
						</div>
						
						<div class="checkbox">
					    	<label for="has_internet"><input type="checkbox" name="has_internet" id="has_internet" value="1"> Internet </label>
						</div>
				  	</div>
				</div>
				...
				<div class="form-group">
		  			...
		  			<div class="col-md-4">
		  				<div class="checkbox">
			    			<label for="has_microwave"><input type="checkbox" name="has_microwave" id="has_microwave" value="1"> Microwave </label>
						</div>

		  				<div class="checkbox">
			    			<label for="has_dishwasher"><input type="checkbox" name="has_dishwasher" id="has_dishwasher" value="1"> Dishwasher </label>
						</div>
		  			</div>
				</div>
			...
			<div class="col-md-6 pull-right">
				<div class="flexslider" style="box-shadow: 0 0 20px #000">
				  	<ul class="slides">
				    	<li><img src="static/images/1bed.png" alt="1 Bedroom Apartment" /></li>
					    <li><img src="static/images/2bed.png" alt="2 Bedroom Apartment" /></li>
					    <li><img src="static/images/studio.png" alt="Studio Apartment" /></li>
				  	</ul>
				</div>
			</div>
		</div>
